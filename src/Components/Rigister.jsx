...
if (/^(?=.*[A-Za-z])(?=.*\d)(?=.*[@#$%^&+=!])[A-Za-z\d@#$%^&+=!]{6,}$/.test(passwordvalue)) {
    ...
    createUser(emailvalue, passwordvalue)
      .then((result) => {
        ...
        alert( result.user,'You Have SuccessFully Create Account')
alert( result.user,'You Have SuccessFully Create Account')
...
updeateProfile(namevalue,photoUrlValue)
        .then((results) => {
            ...
            fetch('https://assignment-njaqjo60c-md-armans-projects-bf1c950b.vercel.app/user', {
                method: 'POST',
                headers: {
            ...
            // fetch('https://assignment-af1d9fnvw-md-armans-projects-bf1c950b.vercel.app/user', {
            //     method: 'POST',
            //     headers: {
            //         'content-type': 'application/json'
            //     },
